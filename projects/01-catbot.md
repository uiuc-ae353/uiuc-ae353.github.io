...
## Bonus points
You can earn up to **5 bonus points** as follows: if you catch **more than one** cat-pilot in the simulation, you will receive **2.5 bonus points for each additional** cat-pilot caught, up to a maximum of **5 bonus points** (i.e., you earn the full 5 points if you catch **three** cat-pilots total). If you successfully catch more than one cat-pilot, be sure to **note this in your report** (in the **Results** section), and ensure your **video submission clearly shows the same result**.
...
- It must include the number of cat-pilots caught in the Results section.
